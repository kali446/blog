...
const Description = ({ description, limit = 200, align }: Props) => {
  ...
  return (
    <p
      className={`w-full text-[1.05rem] font-light leading-[1.75] text-light-primary dark:text-dark-contrast-900 md:w-full xs:text-[1rem] ${
        align === "center" ? "text-center" : ""
      }`}
    >
      {!showFullDescription ? (
        <>
          {truncateString(description, limit)}
          <span
