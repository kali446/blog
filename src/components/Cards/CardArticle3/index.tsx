...
const CardArticle3 = () => {
  return (
    <div className="group flex cursor-pointer flex-col items-start rounded-xl p-4 pb-[0] transition-colors duration-300 hover:bg-white hover:shadow-sm dark:hover:bg-dark-submenuLink">
      <h3 className="mb-2 pr-2 text-[1rem] font-semibold leading-5 text-light-primary dark:text-dark-primary">
        10 Must-Have Gadgets for Every Tech Lover
      </h3>

      <span className="mb-3 text-xs text-light-secondary dark:text-dark-primary">
        February 23, 2023
      </span>
      ...
      <div className="font-medium relative mt-5 h-[3rem] w-full overflow-hidden border-t border-light-contrast-200 text-[.725rem] uppercase tracking-wide text-light-secondary transition-all group-hover:text-light-primary dark:border-dark-contrast-600/40 dark:text-dark-primary dark:group-hover:text-dark-primary">
