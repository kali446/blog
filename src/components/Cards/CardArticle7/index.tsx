    ...
    <div className="group relative h-full overflow-hidden rounded-xl bg-white p-4 !pb-[0]">
      ...
      <div className="relative z-30 flex h-full flex-col items-start justify-between text-white">
        ...
        <div className="w-full">
          <h1 className="sm:text-[1.75rem] sm:leading-[1.2] w-[90%] text-5xl font-semibold leading-[1.1]">
            The Coolest Gadgets from CES 2023
          </h1>

          <p className="pb-2 text-light-contrast-200 shadow-sm">
            <span className="text-xs font-semibold tracking-wide transition-colors duration-300">
              Elliet Alderson
            </span>

            <span className="px-2 text-xs tracking-wide">
              February 27, 2023
            </span>
          </p>

          <p className="pb-5 text-[.875rem] font-extralight text-white/80">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum,
            impedit aliquid. Itaque.
          </p>
