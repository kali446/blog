  ...
  return (
    <div className="group cursor-pointer rounded-lg bg-white p-4 !pb-[0] shadow-sm transition-shadow hover:shadow-lg dark:bg-dark-layoutElement">
      <h2 className="pb-1 text-[1.55rem] font-semibold leading-[1.15] tracking-normal text-light-primary transition-colors duration-300 hover:text-accent dark:text-dark-primary">
        The Latest Gadgets for Gamers: A Review
      </h2>
      ...
      <div className="h-[2.75rem] w-full overflow-hidden">
        <div className="font-medium relative h-full w-full border-t border-light-contrast-300 text-[.725rem] uppercase tracking-wide text-light-secondary transition-all group-hover:text-light-primary dark:border-dark-contrast-200/60 dark:text-dark-primary dark:group-hover:text-dark-primary">
