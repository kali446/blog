...
const CardArticle5 = () => {
  return (
    <div className="group relative cursor-pointer overflow-hidden rounded-xl">
      ...
      <div className="absolute left-[0] top-[0] z-20 h-full w-full bg-light-overlay/30"></div>
      <div className="relative z-30 px-3 pb-3 pt-[7rem] text-white">
        <span className="text-xs font-light uppercase">Wearables</span>
        <h2 className="pb-1 text-xl font-semibold leading-[1.25]">
          Gadget Addiction: How to Recognize It and What to Do
        </h2>
        <p className="pb-2 text-white shadow-sm">
          <span className="text-xs font-semibold tracking-wide transition-colors duration-300">
            Elliet Alderson
          </span>

          <span className="px-2 text-xs tracking-wide">February 27, 2023</span>
        </p>

        <p className="pb-[3.25rem] text-[.875rem] font-extralight leading-[1.5] text-white/80">
