    ...
    >
      ...
      <div className="relative z-20 flex h-full w-full flex-col items-start justify-between p-4 !pb-[0] text-white">
        ...
        <div className={`w-full ${!heightFixed && "pt-[4rem]"}`}>
          ...
          <span className="pb-2 text-xs capitalize tracking-wide text-light-contrast-300">
            February 5, 2024
          </span>

          {showExcerpt && (
            <p className="pb-4 pt-2 text-sm font-extralight text-white/80">
              Lessons from top women entrepreneurs on getting a startup funded.
            </p>
          )}
