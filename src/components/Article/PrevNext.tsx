...
const PrevNext = () => {
  return (
    <div className="mb-[5rem] flex items-center gap-3 border-b border-light-contrast-300 pb-[5rem] dark:border-dark-contrast-300/50 sm:flex-col sm:gap-6">
      <div className="sm:items-center group flex cursor-pointer items-end gap-3 sm:w-full md:w-6/12">
        ...
        <div className="sm:relative">
          <span className="sm:left-0 sm:absolute sm:top-[-150%]  text-xs font-medium uppercase text-light-primary drop-shadow-sm dark:text-dark-primary">
            prev post
          </span>

          <h2 className="sm:mt-0 text-md mt-4 font-semibold leading-5 transition-colors duration-200 hover:text-accent">
            Effortless comfortable full leather lining eye-catching.
          </h2>
        </div>
      </div>
      <div className="group flex cursor-pointer flex-row-reverse items-end gap-3 sm:w-full sm:items-center md:w-6/12">
        ...
        <div className="sm:relative flex flex-col items-end">
          <span className="sm:right-0 sm:absolute sm:top-[-150%] text-xs font-medium uppercase text-light-primary drop-shadow-sm dark:text-dark-primary">
            next post
          </span>

          <h2 className="sm:mt-0 text-md mt-4 text-right font-semibold leading-5 transition-colors duration-200 hover:text-accent">
            Effortless comfortable full leather lining eye-catching.
          </h2>
        </div>
      </div>
