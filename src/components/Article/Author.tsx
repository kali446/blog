...
const Author = () => {
  return (
    <div className="xs:px-0 sm:px-[2rem] mb-[5rem] flex flex-col items-center gap-4 border-b border-light-contrast-300 px-[4rem] pb-5 dark:border-dark-contrast-300/50">
      ...
      <p className="text-center text-[.925rem] font-light leading-relaxed text-light-primary dark:text-dark-secondary">
        ...
        temporibus veritatis fuga. Similique aliquam, neque corrupti qui a
        repellat voluptatem delectus quo, vitae numquam minus. Quidem deleniti
        ipsum quisquam est, voluptates quaerat vitae ea at nisi dolor eveniet et
        ex, nobis architecto incidunt illum sed?
      </p>
    </div>
  );
};
