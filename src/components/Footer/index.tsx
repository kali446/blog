...
hover:text-[#65a6f6] dark:text-dark-contrast-900"
          >
            <svg
              width={18}
              height={18}
          ...
          <li className="flex items-center gap-[.25rem] hover:text-[#C13584] dark:text-dark-contrast-900">
            <svg
              width={18}
              height={18}
              viewBox="0 0 512 512"
          ...
          <li className="flex items-center gap-[.25rem] hover:text-black dark:text-dark-contrast-900">
            <svg
              width={18}
              height={18}
              viewBox="0 0 502 512"
